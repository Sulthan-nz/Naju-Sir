...
module.exports = {
  VERSION: 'v7.3.6',
    ...
    SESSION: process.env.NAJUSIR_CODE === undefined ? '' : process.env.NAJUSIR_CODE,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Najusir' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '919496956830@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    SUPPORT: "919895494822-1632986420",
    SUPPORT2: "919496956830-1627666570",
